...
const __pageData = JSON.parse('{"title":"Quick Start","description":"","frontmatter":{"aside":true},"headers":[{"level":2,"title":"Introduction section","slug":"introduction-section","link":"#introduction-section","children":[]}],"relativePath":"en/sdks/sample-api.md","lastUpdated":1676281064000}');
const _sfc_main = { name: "en/sdks/sample-api.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/sdks/sample-api.md");
