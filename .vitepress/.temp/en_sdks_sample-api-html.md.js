...
const __pageData = JSON.parse('{"title":"API markdown with html text","description":"","frontmatter":{"aside":false},"headers":[{"level":2,"title":"You can use custom css class in markdown with tailwind css","slug":"you-can-use-custom-css-class-in-markdown-with-tailwind-css","link":"#you-can-use-custom-css-class-in-markdown-with-tailwind-css","children":[]}],"relativePath":"en/sdks/sample-api-html.md","lastUpdated":1676281064000}');
const _sfc_main = { name: "en/sdks/sample-api-html.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Response = Response;
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="api-markdown-with-html-text" tabindex="-1">API markdown with html text <a class="header-anchor" href="#api-markdown-with-html-text" aria-hidden="true">#</a></h1><h2 id="you-can-use-custom-css-class-in-markdown-with-tailwind-css" tabindex="-1">You can use custom css class in markdown with tailwind css <a class="header-anchor" href="#you-can-use-custom-css-class-in-markdown-with-tailwind-css" aria-hidden="true">#</a></h2><p><a href="https://tailwindcss.com/" target="_blank" rel="noreferrer">https://tailwindcss.com/</a></p><br>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/sdks/sample-api-html.md");
